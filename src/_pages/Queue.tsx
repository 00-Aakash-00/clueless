...
const Queue: React.FC<QueueProps> = ({ setView }) => {
  ...
  const [currentModel, setCurrentModel] = useState<{ provider: string; model: string }>({ provider: "groq", model: "openai/gpt-oss-20b" })
            ...
            <div className="flex-1 overflow-y-auto mb-3 p-3 rounded-lg bg-white/10 backdrop-blur-md max-h-64 min-h-[120px] glass-content border border-white/20 shadow-lg">
              {chatMessages.length === 0 ? (
                <div className="text-sm text-gray-600 text-center mt-8">
                  ...
                  <br />
                  <span className="text-xs text-gray-500">Click ⚙️ Models to switch AI models</span>
                </div>
              ) : (
